  ...
  return (
    <>
      ...
      <HeroSection
        ...
        backgroundImage="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3"
      />
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <SectionHeader
            title="Contact Us"
            subtitle="We're here to help you and answer any questions you might have"
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="animate-on-scroll">
              <div className="bg-muted rounded-xl p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Innovation Valley, CA 92123</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="h-10 w-10 bg-primary/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                    ...
                    <a href="#" className="h-10 w-10 bg-primary/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M22 7h-7v-2h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14h-8.027c.13 3.211 3.483 3.312 4.588 2.029h3.168zm-7.686-4h4.965c-.105-1.547-1.136-2.219-2.477-2.219-1.466 0-2.277.768-2.488 2.219zm-9.574 6.988h-6.466v-14.967h6.953c5.476.081 5.58 5.444 2.72 6.906 3.461 1.26 3.577 8.061-3.207 8.061zm-3.466-8.988h3.584c2.508 0 2.906-3-.312-3h-3.272v3zm3.391 3h-3.391v3.016h3.341c3.055 0 2.868-3.016.05-3.016z"></path>
                      </svg>
                    </a>
                    <a href="#" className="h-10 w-10 bg-primary/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="mt-8 h-96 rounded-xl overflow-hidden shadow-md">
                {/* Google Maps iframe - replace with actual Google Maps embed code */}
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.0774013580967!2d-122.41941548535708!3d37.77492797975928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sTwitter%20HQ!5e0!3m2!1sen!2sus!4v1654532695896!5m2!1sen!2sus" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 animate-on-scroll">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold">San Francisco (HQ)</h3>
              </div>
              <address className="not-italic text-muted-foreground mb-4">
                123 Tech Plaza<br />
                Innovation Valley, CA 92123<br />
                United States
              </address>
